...
async def get_thumb(videoid):
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(thumbnail) as resp:
            if resp.status == 200:
                ...
                raise OSError("Failed to download thumbnail.")
    ...
    try:
        ...
        raise OSError("Font files not found. Ensure 'ChampuMusic/assets/' contains the required fonts.")
    ...
    try:
        ...
        print("Play icons file not found.")
